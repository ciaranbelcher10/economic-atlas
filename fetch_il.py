...
- unemployment (LRHUTTTTILM156S), bond_yield_10y (IRLTLT01ILM156N),
  debt_gdp (GGGDTAILA188N), deficit (GGNLBAILA188N),
...
FRED_SERIES = {
    ...
    "debt_gdp": ("GGGDTAILA188N", "a", "General government gross debt, % of GDP", "%", None, 1.0),
    "deficit": ("GGNLBAILA188N", "a", "General government net lending/borrowing, % of GDP", "%", None, 1.0),
